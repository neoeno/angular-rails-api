...
file 'app/controllers/api/things_controller.rb', <<-CODE
...
file 'app/views/api/things/index.jbuilder', <<-CODE
json.array! @things
CODE
...
inside("frontend") do
  run "yo angular --coffee"
  run "rm app/views/main.html"
  run "rm app/styles/main.scss"
...
CODE
  ...
  file 'app/styles/main.sass', <<-CODE
...
CODE
  ...
  file "app/scripts/controllers/main.coffee", <<-CODE
'use strict'
